...
if ($useDebug -eq $true) {
    & adb push build/debug_libjni-utils.so /sdcard/Android/data/com.beatgames.beatsaber/files/mods/libjni-utils.so
} else {
    & adb push build/libjni-utils.so /sdcard/Android/data/com.beatgames.beatsaber/files/mods/libjni-utils.so
}
